...
from churnpilot.policy import PolicyError, PolicyReport, simulate_policy
...
def fitted():
    train = make_panel(n_subscribers=1500, n_months=10, seed=41)
    data = make_panel(n_subscribers=800, n_months=10, seed=42)
