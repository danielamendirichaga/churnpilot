"""Data validation — is the configured dataset *usable* by churnpilot?
...
* **fail (✗)** — churnpilot cannot proceed (no target, empty, single-class, ...).
...
class ValidationReport:
    ...
    @property
    def ok(self) -> bool:
        """True when there are no hard failures (churnpilot can proceed)."""
