...
The config is what makes churnpilot domain-agnostic: the user *declares* their target /
...
* :data:`CONFIG_TEMPLATE` — the commented starter written by ``churnpilot init``.
"""
...
class ColumnMap(BaseModel):
    """How churnpilot finds the columns it needs in *your* data.
...
CONFIG_TEMPLATE = """\
# churnpilot config — declares your data source and column mapping.
# Nothing is hardcoded; edit this to point churnpilot at your data.
